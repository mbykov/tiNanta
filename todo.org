...
* 18 июля UOHYD
  ...
  - [ ] прочитать rawcomplete.txt - DP
  - [ ] добавить номер в dhatu_list_cache
  - [ ] uohyd_make_dhatupatha
  - [ ] прогнать g.forms, разделить на гнезда dhatu
  - [ ] uohyd_cache
  - [ ]
  - [ ] повторить parse процесс на новых данных:
  - [ ] посчитать freqs окончаний, максимизировать процент parse
