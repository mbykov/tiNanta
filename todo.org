...
* TODO 10 июля tinAnta
  ...
  - [ ] стандартные окончания для не найденного решения
  - [ ] вручную составить таблицы la-tins, т.е. canonical
  - [ ] написать possible stem - если tin, то из pstem получать possible dhatu
  - [ ] тесты для pstem - но это д.б. "не исключения" - как вычислить "не исключения"?
  - [ ] это те dhatu-anga, где tvar совпадает со стандартным (одним из для luN)
  - [ ]
